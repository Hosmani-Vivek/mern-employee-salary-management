              ...
              <div className="p-6.5">
                ...
                <div className="mb-4.5 flex flex-col gap-6 xl:flex-row">
                  ...
                  <div className="flex items-center justify-center">
                    {preview ? (
                      <figure className="animate-fadeIn relative h-64 w-64 sm:h-40 sm:w-40 md:h-56 md:w-56 lg:h-64 lg:w-64">
                        <img
                          src={preview}
                          alt="People Image"
                        ...
                        <button
                          onClick={imageCancel}
                          className="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 absolute right-2 top-2 rounded-full bg-white p-1.5 focus:outline-none dark:bg-black/30">
